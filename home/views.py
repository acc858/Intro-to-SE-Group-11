...
import random 
from .models import Seller, listing, Buyer, Purchase
...
from .forms import SellerReg, SellerLogForm, BuyerLogForm, BuyerReg, BuyerUpdate, SellerUpdate, SearchForm
...
def return_purchase(request, purchase_id):
    ...
    total_refund += purchase.listing.price * purchase.quantity
